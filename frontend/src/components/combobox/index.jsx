          ...
          <>
            {options?.length > 0 &&
              options?.map((category) => (
                <div
                  key={category._id}
                  className="relative text-gray-900 cursor-default select-none py-2 pl-3 pr-9 hover:bg-indigo-600 hover:text-white"
            ...
            {query.length > 0 && !isExactMatch && (
              <div className="mt-1 max-h-56 w-full overflow-auto  bg-white text-basesm:text-sm">
                <div
